...
| 4 | **Posesión** | el `PlayerController` posee un `BP_CameraPawn` y **nunca** un personaje | ✅ hecho, [framework](04-mapa-de-clases.md) | el tema se demuestra igual, y con una sola ruta de input en vez de dos |
